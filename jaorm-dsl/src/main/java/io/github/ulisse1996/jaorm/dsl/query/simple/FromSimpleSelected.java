...
public interface FromSimpleSelected extends WithResult,
        WithSimpleJoin, WithSimpleOrder, WithSimpleWhere,
        WithSubQuerySupport, WithSimpleLimit, WithSimpleOffset, WithSimpleGroup {
}
