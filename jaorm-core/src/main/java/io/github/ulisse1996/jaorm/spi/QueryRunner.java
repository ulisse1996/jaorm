...
public abstract class QueryRunner {
            ...
            UpdateBatchExecutor executor = new UpdateBatchExecutor(preparedStatement, params, autoGenerated.keySet())) {
                if (executor.getResultSet() != null) {
                    ...
                    if (specific.isCustomGetResultSet()) {
                        resultSets = checkCustomResultsSets(specific, preparedStatement, autoGenerated, executor, generated);
                    } else {
    ...
    private List<ResultSet> checkCustomResultsSets(GeneratedKeysSpecific specific, PreparedStatement preparedStatement,
                                                   Map<String, Class<?>> autoGenerated, UpdateBatchExecutor executor,
                                                   List<Map<String, Object>> generated) throws SQLException {
        List<ResultSet> resultSets = specific.getResultSets(preparedStatement);
