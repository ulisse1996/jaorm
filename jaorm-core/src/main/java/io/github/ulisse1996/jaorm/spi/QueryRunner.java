...
public abstract class QueryRunner {
    ...
    protected List<Map<String, Object>> doBatchUpdate(String query, List<List<SqlParameter>> params, Map<String, Class<?>> autoGenerated) {
        ...
        try (Connection connection = getConnection();
            ...
            UpdateBatchExecutor executor = new UpdateBatchExecutor(preparedStatement, params)) {
