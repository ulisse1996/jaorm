...
@Table(name = "TABLE")
public class SimpleEntityWithRelationshipList {
    ...
    private List<RelationshipTest> col3;

    public List<RelationshipTest> getCol3() {
        return col3;
    }

    public void setCol3(List<RelationshipTest> col3) {
        this.col3 = col3;
    }
