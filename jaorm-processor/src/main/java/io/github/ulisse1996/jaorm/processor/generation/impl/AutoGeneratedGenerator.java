...
public class AutoGeneratedGenerator extends Generator {
    ...
    private void generateGenerators(List<GenerationResult> results) {
        TypeSpec generators = TypeSpec.classBuilder("Generators" + ProcessorUtils.randomIdentifier())
        ...
        ProcessorUtils.generateSpi(processingEnvironment,
                new GeneratedFile(JAORM_PACKAGE, generators, ""), GeneratorsService.class);
    }
