...
CREATE TABLE MY_PROG (ID_COL INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY, PROGR INTEGER DEFAULT MY_PROG_SEQUENCE.nextval, MY_VALUE VARCHAR(30));
